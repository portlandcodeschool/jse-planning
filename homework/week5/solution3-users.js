var makeUser = (function() {// begin IIFE...
  ...
  // The factory itself:
  function innerMakeUser(name,passwd) {
    // name and passwd are private; accessible only from two functions defined within innerMakeUser
    var user = {
  ...
  innerMakeUser.getLog = function(user) { //user can be either name or object
    if (!user)
  ...
  return innerMakeUser;  //external link to innerMakeUser preserves IIFE scope (including sharedLog)
})(); //do this IIFE now!
