...
function GUI(game) { //ctor
    ...
    this.gridview = this.mainview.gridview;

    // delegate some actions to gridview:
    this.show = function(where,what) {
        return this.gridview.show(where,what);
    }
    this.hideSoon = function(locs) {
        return this.gridview.doSoon(locs,'hide');
    }
    this.removeSoon = function(locs) {
        return this.gridview.doSoon(locs,'remove');
    }
}
